...
<html lang="{{ langcode|safe }}" class="no-js">
  <head>
    ...
    <title>{{headTitle|default("YETIsense") }} | {{system_hostname}}.{{system_domain}}</title>
    {% set theme_name = ui_theme|default('yetisense') %}
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href="/">
            {% if file_exists(["/usr/local/yetisense/www/themes/",theme_name,"/build/images/default-logo.svg"]|join("")) %}
            ...
            {% endif %}
            {% if file_exists(["/usr/local/yetisense/www/themes/",theme_name,"/build/images/icon-logo.svg"]|join("")) %}
  ...
  <main class="page-content col-sm-9 col-sm-push-3 col-lg-10 col-lg-push-2">
      ...
      <div class="row">
        ...
        <section class="page-content-main">
          <div class="container-fluid">
            <div class="row">
                <!-- notification banner dynamically inserted here (yetisense_status.js) -->
    ...
    <div class="modal fade" id="YETIsenseStdWaitDialog" tabindex="-1" data-backdrop="static" data-keyboard="false">
