...
* The current YETIsense version where the bug first appeared
* The last YETIsense version where the bug did not exist
...
https://yetisense.org/about/road-map/

Feature requests beyond the scope of YETIsense may still be provided
using the plugin framework:

https://github.com/Christopher-YeTI/plugins/issues
